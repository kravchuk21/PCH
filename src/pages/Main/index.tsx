            ...
            <div className={styles.mainHeader}>
                ...
                <div className={styles.mainInfo}>
                    <div className={styles.mainInfoText}>
                        ...
                        <p className={styles.mainText}>ПЧШ - это лучшие пончики, сочные чебуреки и вкуснейшая шаурма</p>
                        <Link to={"/menu"} className={styles.mainButton}>Меню</Link>
                    </div>
                    <div className={styles.images}>
                        {isDesktop &&
                            <img className={clsx(styles.mainImage, styles.mainImage1)} src={FreeImg} alt="ПЧШ"/>}
                        <img className={clsx({[styles.mobileImage]: !isDesktop}, {[styles.mainImage]: isDesktop})}
                             src={MainImage} alt="ПЧШ"/>
                        {isDesktop &&
                            <img className={clsx(styles.mainImage, styles.mainImage3)} src={ShaurmaImg} alt="ПЧШ"/>}
                    </div>
                </div>
            </div>
                            ...
                            <div className={styles.infoBlock}>
                                ...
                                <div className={styles.content}>
                                    ...
                                    <div className={styles.text}>
                                        Команда ПЧШ работает 7 дней в неделю с 10:00 до 22:00, чтобы каждый из вас смог
                                        в любое
